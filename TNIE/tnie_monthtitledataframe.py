...
def main():
    ...
    params = {
        ...
        "params": {"behavior": "allow", "downloadPath": home_directory},
    }
    ...
    for id_entry in ids:
        ...
        if script_text:
            ...
            if latest_vol_match:
                ...
                time.sleep(5)
                WebDriverWait(browser, 10).until(
                    EC.presence_of_element_located((By.CLASS_NAME, "fullpdflink"))
                )
...
main()
downloads_directory = os.path.expanduser(
    "~"
)  # Set the downloads directory to the home directory
